...
const NewsCard: React.FC<NewsCardProps> = ({ article, getCategoryColor }) => {
    return (
        ...
        <div className="relative min-h-[420px] bg-transparent group">
            ...
            <div className="absolute top-0 left-0 w-full bg-gray-800 rounded-xl shadow-md transition-all duration-300 ease-in-out group-hover:z-20 group-hover:shadow-2xl group-hover:scale-105 group-hover:h-auto min-h-full flex flex-col overflow-hidden ring-1 ring-white/10">
                ...
                {/* Content Section */}
                <div className="p-5 flex flex-col grow bg-gray-800">
                    ...
                    <h2 className="text-xl font-bold text-gray-100 mb-3 leading-tight group-hover:text-blue-400 transition-colors">
                        {article.title}
                    </h2>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center text-blue-400 font-medium text-sm">
